...
public class ServerUtils {
    ...
    //TODO MGW by Djer |JavaDoc| En générale on ne précise pas de "author" sur un attribut/constantes (surtout si c'est le même que la classe). Tu pourrais indiquer à  quoi sert cette constantes (le nommage étant claire un simple "User agent sent to the server" serait suffisant).
    /** @author mgw **/
    ...
    /**
     * get the labels' user's url.  //TODO MGW by Djer |JavaDoc| Ne renvoie pas une URL (cf commentaires mÃ©thode "nextEvent(...)".
     * @return the url with the next event of the defined user if it exists
    ...
    public String callServer(final String url, final String userKey) throws IOException {
        ...
        //TODO MGW by Djer || Ton serveur est configuré pour écouter sur le port 8081 ("server.port=8081" du fichier application.properties)
